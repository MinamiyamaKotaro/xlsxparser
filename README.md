...
| | `xlsxparser` | `calamine` |
|---|---|---|
| wall time / parse | 17.32 ms | 7.38 ms |
| instructions / parse | 203,672,568 | 84,912,087 |
| peak memory footprint | 6.90 MB | 2.38 MB |
| cells walked | 25,517 | 663 |
| **time / cell walked** | **679 ns** | 11.13 µs |
| **instructions / cell walked** | **7,983** | 128,073 |
...
679 ns and 7,983 instructions per cell against `calamine`'s 11.13 µs and
128,073 instructions per cell — roughly **16.4x cheaper per cell**.
...
![xlsxparser vs calamine, wall-clock time: xlsxparser 17.32ms/parse (25,517 cells) vs calamine 7.38ms/parse (663 cells) — but normalized per cell walked, xlsxparser is about 16.4x cheaper (679ns vs 11.13µs)](docs/benchmarks/merge_cell_benchmark_time.png)
